...
export interface IDialerSessionFilters{
  vm;
  gm;
  list;
  tz;
...
export class DialerService {
  ...
  public filterData:IDialerSessionFilters={} as IDialerSessionFilters;

  private filtersRecord: BehaviorSubject<IDialerSessionFilters> = new BehaviorSubject<IDialerSessionFilters>(this.filterData);

  public getdialerSessionFiltersRecord(){
    return this.filtersRecord.asObservable();
  }
  public setdialerSessionFiltersRecord(dialerSessionFilters: IDialerSessionFilters): void {
    this.filtersRecord.next(dialerSessionFilters);
  }
  ...
  GetOnGoingCalls() {
    return this.http.get(`${this.baseURL}/v0.1/callinfo/getCallsforManager`);
  }
  ...
  logout(user){
    return this.http.put(`${this.baseURL}/v0.1/auth/logout`,user);
  }
